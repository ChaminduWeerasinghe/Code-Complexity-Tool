...
"public class PhysicsTeacher1 extends physicsteacher2Teacher{\r\n" +
"   String mainSubject = \"Physics\";\r\n" +
"   public static void main(String args[]){\r\n" +
"	PhysicsTeacher obj = new PhysicsTeacher();\r\n" +
"	System.out.println(obj.collegeName);\r\n" +
...
"public class PhysicsTeacher1 extends physicsteacher3Teacher{\r\n" +
"   String mainSubject = \"Physics\";\r\n" +
"   public static void main(String args[]){\r\n" +
"	PhysicsTeacher obj = new PhysicsTeacher();\r\n" +
"	System.out.println(obj.collegeName);\r\n" +
...
"   }\r\n" +
        ...
        Map<String, Integer> analyzedData = main.analyzeInheritance(code);
    ...
    private String[] filterClassDefs(String code) {
    ...
    private Set<String> filterIndirectInheritances(String[] classDefinitions, Set<String> directInheritances){
        ...
        for(int a =0; a < classDefinitions.length; a ++){
