...
<body>
	...
	<form action="CouplingServelt" method="post">
		<table style="width: 100%">
			...
			<tr>
				...
				<td><input type="text" id="t1" name="wR" value="2" size="2"><br>
					<br></td>
			...
			<tr>
				<td>A regular method calling another regular method in the same
					file</td>
				<td><input type="text" id="t2" name="wMcms" value="2" size="2"><br>
					<br></td>
		...
		<input type="hidden" name="fileName" value="<%out.print(request.getParameter("fileName"));%>">
	...
	<form action="Output.jsp">
		...
		<input type="hidden" name="fileName" value="<%out.print(request.getParameter("fileName"));%>">
		<input type="submit" class="button" value="Measure">
	</form>
